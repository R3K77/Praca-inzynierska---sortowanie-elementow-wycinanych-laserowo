...
def main(json_name):
    ...
    angle_sheet,translation_mm,sheetData = sheetRotationTranslation(BgrSubstractor_Sheet,SHEET_CAMERA_ID,crop_values_sheet,SHEET_SIZE)
...
if __name__ == "__main__":
    ...
    main('blacha8')  
    readRobotCVJsonData('cv_data_blacha8_sheetTest.json')  
